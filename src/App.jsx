...
import { handleFathomTrackEvent, updatePath } from './utils/';
import { importSharedPins } from './Tools/Pins/Pin.utils';
import { MODES, FATHOM_TRACK_EVENT_LIST } from './const';
...
class App extends Component {
  ...
  async componentDidUpdate(prevProps) {
    ...
    if (prevProps.is3D && !this.props.is3D) {
      ...
      handleFathomTrackEvent(FATHOM_TRACK_EVENT_LIST['2D_MODE_WIDGET']);
    }
    if (!prevProps.is3D && this.props.is3D) {
