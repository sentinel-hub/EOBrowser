...
const stories = storiesOf('EOB3 - Modal - Image Download', module);
...
const presets = {
  'Sentinel-2 L1C': [
    ...
    },
    {
      ...
      dataset: 'S2L1C',
      image:
        'https://services.sentinel-hub.com/ogc/wms/cd2801-YOUR-INSTANCEID-HERE?showLogo=false&SERVICE=WMS&REQUEST=GetMap&LAYERS=2_FALSE_COLOR&BBOX=-19482,6718451,-18718,6719216&MAXCC=10&WIDTH=40&HEIGHT=40&evalscriptoverrides=Z2Fpbk92ZXJyaWRlPTE7&FORMAT=image/jpeg&bgcolor=00000000&transparent=1&TIME=2015-01-01/2019-12-24',
      legendDefinitionJsonUrl: null,
    },
    {
      ...
      dataset: 'S2L1C',
      image:
        'https://services.sentinel-hub.com/ogc/wms/cd2801-YOUR-INSTANCEID-HERE?showLogo=false&SERVICE=WMS&REQUEST=GetMap&LAYERS=4-FALSE-COLOR-URBAN&BBOX=-19482,6718451,-18718,6719216&MAXCC=10&WIDTH=40&HEIGHT=40&evalscriptoverrides=Z2Fpbk92ZXJyaWRlPTE7&FORMAT=image/jpeg&bgcolor=00000000&transparent=1&TIME=2015-01-01/2019-12-24',
      legendDefinitionJsonUrl: null,
    },
    {
      id: '3_NDVI',
      ...
      image:
        'https://services.sentinel-hub.com/ogc/wms/cd2801-YOUR-INSTANCEID-HERE?showLogo=false&SERVICE=WMS&REQUEST=GetMap&LAYERS=3_NDVI&BBOX=-19482,6718451,-18718,6719216&MAXCC=10&WIDTH=40&HEIGHT=40&evalscriptoverrides=Z2Fpbk92ZXJyaWRlPTE7&FORMAT=image/jpeg&bgcolor=00000000&transparent=1&TIME=2015-01-01/2019-12-24',
    ...
    },
    {
      ...
      image:
        'https://services.sentinel-hub.com/ogc/wms/cd2801-YOUR-INSTANCEID-HERE?showLogo=false&SERVICE=WMS&REQUEST=GetMap&LAYERS=5-MOISTURE-INDEX1&BBOX=-19482,6718451,-18718,6719216&MAXCC=10&WIDTH=40&HEIGHT=40&evalscriptoverrides=Z2Fpbk92ZXJyaWRlPTE7&FORMAT=image/jpeg&bgcolor=00000000&transparent=1&TIME=2015-01-01/2019-12-24',
      legendDefinitionJsonUrl:
    ...
    },
    {
      ...
      dataset: 'S2L1C',
      image:
        'https://services.sentinel-hub.com/ogc/wms/cd2801-YOUR-INSTANCEID-HERE?showLogo=false&SERVICE=WMS&REQUEST=GetMap&LAYERS=6-SWIR&BBOX=-19482,6718451,-18718,6719216&MAXCC=10&WIDTH=40&HEIGHT=40&evalscriptoverrides=Z2Fpbk92ZXJyaWRlPTE7&FORMAT=image/jpeg&bgcolor=00000000&transparent=1&TIME=2015-01-01/2019-12-24',
      legendDefinitionJsonUrl: null,
    },
    {
      id: '7-NDWI',
      ...
      dataset: 'S2L1C',
      image:
        'https://services.sentinel-hub.com/ogc/wms/cd2801-YOUR-INSTANCEID-HERE?showLogo=false&SERVICE=WMS&REQUEST=GetMap&LAYERS=7-NDWI&BBOX=-19482,6718451,-18718,6719216&MAXCC=10&WIDTH=40&HEIGHT=40&evalscriptoverrides=Z2Fpbk92ZXJyaWRlPTE7&FORMAT=image/jpeg&bgcolor=00000000&transparent=1&TIME=2015-01-01/2019-12-24',
      legendDefinitionJsonUrl: null,
    },
    {
      id: '8-NDSI',
      ...
      image:
        'https://services.sentinel-hub.com/ogc/wms/cd2801-YOUR-INSTANCEID-HERE?showLogo=false&SERVICE=WMS&REQUEST=GetMap&LAYERS=8-NDSI&BBOX=-19482,6718451,-18718,6719216&MAXCC=10&WIDTH=40&HEIGHT=40&evalscriptoverrides=Z2Fpbk92ZXJyaWRlPTE7&FORMAT=image/jpeg&bgcolor=00000000&transparent=1&TIME=2015-01-01/2019-12-24',
      legendDefinitionJsonUrl:
