...
import DataSourceGroupTooltip from './../DataSourceGroupTooltip';
      ...
      return (
        <div className="dataSourceGroup">
          <label className="align-checkbox">
            <input type="checkbox" onChange={this.toggleChecked} checked={checked} />&nbsp;{label}
          </label>

          {dataSourceTooltip && (
            <HelpTooltip direction="right" closeOnClickOutside={true} className="padOnLeft">
              <DataSourceGroupTooltip dataSourceGroup={dataSourceTooltip} />
            </HelpTooltip>
          )}
