...
const planetApiKey = import.meta.env && import.meta.env.VITE_PLANET_API_KEY;
...
const EDUCATION_THEMES = [
  {
    ...
    content: [
      ...
      {
        name: 'EOB3 Sentinel-1-AWS_IW_VV+VH API',
        service: 'WMS',
    ...
    pins: [
      ...
      },
      {
        ...
        visualizationUrl: 'https://services.sentinel-hub.com/ogc/wms/f2068f-YOUR-INSTANCEID-HERE',
        description:
          'In late 2023 and early 2024, north-western Europe experienced very high levels of rainfall, which led to widespread river flooding. In the winter months, when multispectral imagery is degraded by lower light levels and widespread cloud cover, the Sentinel-1 SAR platform offers an ideal platform for monitoring surface water flooding at a regional scale as the sensor can penetrate the cloud cover. The low backscatter of surface waters also clearly distinguishes them from other land cover types. For example, in this [timelapse](https://sentinelshare.page.link/ZjHP), which uses the VV polarisation to detect surface water, you can get an idea of how quickly the upper reaches of the Thames River floodplain flooded in early January.',
        evalscript:
...
export const DEFAULT_THEMES = [
  {
    ...
    content: [
      ...
      },
      {
        name: 'Planet NICFI',
        service: 'WMTS',
        url: `https://api.planet.com/basemaps/v1/mosaics/wmts?api_key=${planetApiKey}`,
      },
      {
      ...
      },
      {
        ...
        url: 'https://creodias.sentinel-hub.com/ogc/wms/9a86a8-YOUR-INSTANCEID-HERE',
      },
      {
        name: 'River and Lake Ice Extent - Sentinel-2',
        url: 'https://creodias.sentinel-hub.com/ogc/wms/96e44e-YOUR-INSTANCEID-HERE',
      },
      {
        name: 'River and Lake Ice Extent S1+S2',
        url: 'https://creodias.sentinel-hub.com/ogc/wms/8cf23f-YOUR-INSTANCEID-HERE',
      },
      {
