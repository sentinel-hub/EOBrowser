...
export const DEFAULT_THEMES = [
  {
    ...
    content: [
      ...
      },
      {
        name: 'DEM MAPZEN_EU',
        service: 'WMS',
        url: 'https://services.sentinel-hub.com/ogc/wms/7ffc45-YOUR-INSTANCEID-HERE',
        preselected: true,
      },
      {
        name: 'DEM COPERNICUS_30',
        service: 'WMS',
        url: 'https://services.sentinel-hub.com/ogc/wms/6448ff-YOUR-INSTANCEID-HERE',
      },
      {
        name: 'DEM COPERNICUS_90',
        service: 'WMS',
        url: 'https://services.sentinel-hub.com/ogc/wms/bdf8d9-YOUR-INSTANCEID-HERE',
      },
      {
        name: 'Proba-V',
        service: 'WMS',
      ...
      },
      {
        ...
        url: 'https://creodias.sentinel-hub.com/ogc/wms/968dcd-YOUR-INSTANCEID-HERE',
      },
      {
        name: 'Water Bodies',
