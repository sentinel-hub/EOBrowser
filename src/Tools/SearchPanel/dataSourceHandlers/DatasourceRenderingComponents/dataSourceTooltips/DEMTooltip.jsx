...
const MapzenTooltip = () => <ReactMarkdown children={MapzenMarkdown()} linkTarget="_blank" />;
const Copernicus30Tooltip = () => <ReactMarkdown children={Copernicus30Markdown()} linkTarget="_blank" />;
const Copernicus90Tooltip = () => <ReactMarkdown children={Copernicus90Markdown()} linkTarget="_blank" />;
