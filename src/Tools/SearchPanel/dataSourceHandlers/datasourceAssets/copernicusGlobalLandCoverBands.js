...
export const GLOBAL_LAND_COVER_BANDS = [
  {
    ...
    description: t`Main discrete land cover classification according to FAO LCCS scheme`,
    color: '',
  },
  {
  ...
  },
  {
    ...
    description: t`Data density indicator showing quality of the EO input data (0 = bad, 100 = perfect data)`,
    color: '',
  },
  {
    name: 'Change_Confidence_layer',
    description: t`Quality layer regarding the change detection of the current mapped year to the previous mapped year. It is a 3 level confidence mask for all CONSO and NRT maps with value definitions as:
0 = No change.
