...
import { MAX_SH_IMAGE_SIZE, FATHOM_TRACK_EVENT_LIST } from '../../const';
...
export function ImageDownloadForms(props) {
  ...
  function onDownloadImage(selectedTab) {
    if (selectedTab === TABS.BASIC) {
      ...
      handleFathomTrackEvent(FATHOM_TRACK_EVENT_LIST.BASIC_DOWNLOAD_BUTTON);
    }
    if (selectedTab === TABS.ANALYTICAL) {
      props.onDownloadAnalytical(analyticalFormState);
      handleFathomTrackEvent(FATHOM_TRACK_EVENT_LIST.ANALYTICAL_DOWNLOAD_BUTTON);
    }
    if (selectedTab === TABS.PRINT) {
      props.onDownloadPrint(printFormState);
      handleFathomTrackEvent(FATHOM_TRACK_EVENT_LIST.HIGH_RES_DOWNLOAD_BUTTON);
    }
